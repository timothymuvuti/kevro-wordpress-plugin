 ...
 * Admin API class.
 */
class Import_Products_from_Kevro_Admin_API {
	...
	public function display_field( $data = array(), $post = null, $echo = true ) {
		...
		switch ( $field['type'] ) {
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image', 'import-products-from-kevro' ) . '" data-uploader_button_text="' . __( 'Use image', 'import-products-from-kevro' ) . '" class="image_upload_button button" value="' . __( 'Upload new image', 'import-products-from-kevro' ) . '" />' . "\n";
				$html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="' . __( 'Remove image', 'import-products-from-kevro' ) . '" />' . "\n";
